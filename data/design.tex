...
depending on the category of the data.  This choice contrasts with a
``spreadsheet''-style design, with separate columns for each relevant quantity
or averaging system.  This choice offers much more flexiblity, since it allows
for scalability.  The database can then support the addition of many different
