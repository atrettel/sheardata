...
for duct in ducts:
    ...
    with open( duct_globals_filename, "r" ) as duct_globals_file:
        ...
        for duct_globals_row in duct_globals_reader:
            ...
            # the full flow range.
            # \end{quote}
            mt_bulk_velocity = sd.IT_IMPACT_TUBE
            ...
            sd.set_station_value( cursor, station_id, sd.Q_BULK_VELOCITY,                  bulk_velocity, value_type_id=sd.VT_BOTH_AVERAGES, method_ids=[mt_bulk_velocity], )
