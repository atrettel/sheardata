    ...
    for globals_row in globals_reader:
        ...
        with open( station_filename, "r" ) as station_file:
            ...
            for station_row in station_reader:
                ...
                sd.set_point_value( cursor, point_id, sd.Q_STREAMWISE_VELOCITY,    u,                    value_type_id=sd.VT_BOTH_AVERAGES, method_ids=[sd.IT_PITOT_STATIC_TUBE], note_ids=current_notes, )
                sd.set_point_value( cursor, point_id, sd.Q_SPANWISE_VELOCITY,      w,                    value_type_id=sd.VT_BOTH_AVERAGES, method_ids=[sd.IT_ASSUMPTION],                             )
                sd.set_point_value( cursor, point_id, sd.Q_OUTER_LAYER_VELOCITY,   outer_layer_velocity, value_type_id=sd.VT_BOTH_AVERAGES, method_ids=[sd.IT_PITOT_STATIC_TUBE],                      )
