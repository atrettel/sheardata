...
measurement_techniques[ sd.MT_ASSERTION                                ] = MeasTech( "assertion",                                sd.MT_REASONING,                                    )
...
quantities[ sd.Q_VELOCITY_GRADIENT_XX             ] = quantity( "streamwise velocity gradient in streamwise direction",          time_exponent=-1.0,                                                       )
quantities[ sd.Q_VELOCITY_GRADIENT_XY             ] = quantity( "streamwise velocity gradient in transverse direction",          time_exponent=-1.0,                                                       )
quantities[ sd.Q_VELOCITY_GRADIENT_XZ             ] = quantity( "streamwise velocity gradient in spanwise direction",            time_exponent=-1.0,                                                       )
quantities[ sd.Q_VELOCITY_GRADIENT_YX             ] = quantity( "transverse velocity gradient in streamwise direction",          time_exponent=-1.0,                                                       )
quantities[ sd.Q_VELOCITY_GRADIENT_YY             ] = quantity( "transverse velocity gradient in transverse direction",          time_exponent=-1.0,                                                       )
quantities[ sd.Q_VELOCITY_GRADIENT_YZ             ] = quantity( "transverse velocity gradient in spanwise direction",            time_exponent=-1.0,                                                       )
quantities[ sd.Q_VELOCITY_GRADIENT_ZX             ] = quantity( "spanwise velocity gradient in streamwise direction",            time_exponent=-1.0,                                                       )
quantities[ sd.Q_VELOCITY_GRADIENT_ZY             ] = quantity( "spanwise velocity gradient in transverse direction",            time_exponent=-1.0,                                                       )
quantities[ sd.Q_VELOCITY_GRADIENT_ZZ             ] = quantity( "spanwise velocity gradient in spanwise direction",              time_exponent=-1.0,                                                       )
...
quantities[ sd.Q_INNER_LAYER_VELOCITY_CROSS_COVARIANCE_XY           ] = quantity( "inner-layer velocity cross covariance, streamwise-transverse",                                                            )
quantities[ sd.Q_INNER_LAYER_VELOCITY_CROSS_COVARIANCE_XZ           ] = quantity( "inner-layer velocity cross covariance, streamwise-spanwise",                                                              )
quantities[ sd.Q_INNER_LAYER_VELOCITY_CROSS_COVARIANCE_YZ           ] = quantity( "inner-layer velocity cross covariance, transverse-spanwise",                                                              )
...
quantities[ sd.Q_MORKOVIN_SCALED_VELOCITY_CROSS_COVARIANCE_XY       ] = quantity( "Morkovin-scaled velocity cross covariance, streamwise-transverse",                                                        )
quantities[ sd.Q_MORKOVIN_SCALED_VELOCITY_CROSS_COVARIANCE_XZ       ] = quantity( "Morkovin-scaled velocity cross covariance, streamwise-spanwise",                                                          )
quantities[ sd.Q_MORKOVIN_SCALED_VELOCITY_CROSS_COVARIANCE_YZ       ] = quantity( "Morkovin-scaled velocity cross covariance, transverse-spanwise",                                                          )
