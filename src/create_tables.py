...
quantities[ sd.Q_VELOCITY_GRADIENT[1,1]           ] = quantity( "streamwise velocity gradient in streamwise direction",          time_exponent=-1.0,                                                       )
quantities[ sd.Q_VELOCITY_GRADIENT[1,2]           ] = quantity( "streamwise velocity gradient in transverse direction",          time_exponent=-1.0,                                                       )
quantities[ sd.Q_VELOCITY_GRADIENT[1,3]           ] = quantity( "streamwise velocity gradient in spanwise direction",            time_exponent=-1.0,                                                       )
quantities[ sd.Q_VELOCITY_GRADIENT[2,1]           ] = quantity( "transverse velocity gradient in streamwise direction",          time_exponent=-1.0,                                                       )
quantities[ sd.Q_VELOCITY_GRADIENT[2,2]           ] = quantity( "transverse velocity gradient in transverse direction",          time_exponent=-1.0,                                                       )
quantities[ sd.Q_VELOCITY_GRADIENT[2,3]           ] = quantity( "transverse velocity gradient in spanwise direction",            time_exponent=-1.0,                                                       )
quantities[ sd.Q_VELOCITY_GRADIENT[3,1]           ] = quantity( "spanwise velocity gradient in streamwise direction",            time_exponent=-1.0,                                                       )
quantities[ sd.Q_VELOCITY_GRADIENT[3,2]           ] = quantity( "spanwise velocity gradient in transverse direction",            time_exponent=-1.0,                                                       )
quantities[ sd.Q_VELOCITY_GRADIENT[3,3]           ] = quantity( "spanwise velocity gradient in spanwise direction",              time_exponent=-1.0,                                                       )

quantities[ sd.Q_STRESS[1,1] ] = quantity( "normal stress (XX)", mass_exponent=+1.0, length_exponent=-1.0, time_exponent=-2.0, )
quantities[ sd.Q_STRESS[1,2] ] = quantity(  "shear stress (XY)", mass_exponent=+1.0, length_exponent=-1.0, time_exponent=-2.0, )
quantities[ sd.Q_STRESS[1,3] ] = quantity(  "shear stress (XZ)", mass_exponent=+1.0, length_exponent=-1.0, time_exponent=-2.0, )
quantities[ sd.Q_STRESS[2,2] ] = quantity( "normal stress (YY)", mass_exponent=+1.0, length_exponent=-1.0, time_exponent=-2.0, )
quantities[ sd.Q_STRESS[2,3] ] = quantity(  "shear stress (YZ)", mass_exponent=+1.0, length_exponent=-1.0, time_exponent=-2.0, )
quantities[ sd.Q_STRESS[3,3] ] = quantity( "normal stress (ZZ)", mass_exponent=+1.0, length_exponent=-1.0, time_exponent=-2.0, )
...
quantities[ sd.Q_VELOCITY_COVARIANCE[1,1] ] = quantity( "velocity covariance (XX)", length_exponent=+2.0, time_exponent=-2.0, )
quantities[ sd.Q_VELOCITY_COVARIANCE[1,2] ] = quantity( "velocity covariance (XY)", length_exponent=+2.0, time_exponent=-2.0, )
quantities[ sd.Q_VELOCITY_COVARIANCE[1,3] ] = quantity( "velocity covariance (XZ)", length_exponent=+2.0, time_exponent=-2.0, )
quantities[ sd.Q_VELOCITY_COVARIANCE[2,2] ] = quantity( "velocity covariance (YY)", length_exponent=+2.0, time_exponent=-2.0, )
quantities[ sd.Q_VELOCITY_COVARIANCE[2,3] ] = quantity( "velocity covariance (YZ)", length_exponent=+2.0, time_exponent=-2.0, )
quantities[ sd.Q_VELOCITY_COVARIANCE[3,3] ] = quantity( "velocity covariance (ZZ)", length_exponent=+2.0, time_exponent=-2.0, )

quantities[ sd.Q_INNER_LAYER_VELOCITY_COVARIANCE[1,1] ] = quantity( "inner-layer velocity covariance (XX)", )
quantities[ sd.Q_INNER_LAYER_VELOCITY_COVARIANCE[1,2] ] = quantity( "inner-layer velocity covariance (XY)", )
quantities[ sd.Q_INNER_LAYER_VELOCITY_COVARIANCE[1,3] ] = quantity( "inner-layer velocity covariance (XZ)", )
quantities[ sd.Q_INNER_LAYER_VELOCITY_COVARIANCE[2,2] ] = quantity( "inner-layer velocity covariance (YY)", )
quantities[ sd.Q_INNER_LAYER_VELOCITY_COVARIANCE[2,3] ] = quantity( "inner-layer velocity covariance (YZ)", )
quantities[ sd.Q_INNER_LAYER_VELOCITY_COVARIANCE[3,3] ] = quantity( "inner-layer velocity covariance (ZZ)", )

quantities[ sd.Q_MORKOVIN_SCALED_VELOCITY_COVARIANCE[1,1] ] = quantity( "Morkovin-scaled velocity covariance (XX)", )
quantities[ sd.Q_MORKOVIN_SCALED_VELOCITY_COVARIANCE[1,2] ] = quantity( "Morkovin-scaled velocity covariance (XY)", )
quantities[ sd.Q_MORKOVIN_SCALED_VELOCITY_COVARIANCE[1,3] ] = quantity( "Morkovin-scaled velocity covariance (XZ)", )
quantities[ sd.Q_MORKOVIN_SCALED_VELOCITY_COVARIANCE[2,2] ] = quantity( "Morkovin-scaled velocity covariance (YY)", )
quantities[ sd.Q_MORKOVIN_SCALED_VELOCITY_COVARIANCE[2,3] ] = quantity( "Morkovin-scaled velocity covariance (YZ)", )
quantities[ sd.Q_MORKOVIN_SCALED_VELOCITY_COVARIANCE[3,3] ] = quantity( "Morkovin-scaled velocity covariance (ZZ)", )
