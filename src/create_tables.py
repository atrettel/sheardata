...
quantities[ sd.Q_STRESS[sd.D_STREAMWISE,sd.D_STREAMWISE] ] = quantity( "normal stress (XX)", mass_exponent=+1.0, length_exponent=-1.0, time_exponent=-2.0, )
quantities[ sd.Q_STRESS[sd.D_STREAMWISE,sd.D_TRANSVERSE] ] = quantity(  "shear stress (XY)", mass_exponent=+1.0, length_exponent=-1.0, time_exponent=-2.0, )
quantities[ sd.Q_STRESS[sd.D_STREAMWISE,sd.D_SPANWISE  ] ] = quantity(  "shear stress (XZ)", mass_exponent=+1.0, length_exponent=-1.0, time_exponent=-2.0, )
quantities[ sd.Q_STRESS[sd.D_TRANSVERSE,sd.D_TRANSVERSE] ] = quantity( "normal stress (YY)", mass_exponent=+1.0, length_exponent=-1.0, time_exponent=-2.0, )
quantities[ sd.Q_STRESS[sd.D_TRANSVERSE,sd.D_SPANWISE  ] ] = quantity(  "shear stress (YZ)", mass_exponent=+1.0, length_exponent=-1.0, time_exponent=-2.0, )
quantities[ sd.Q_STRESS[sd.D_SPANWISE,  sd.D_SPANWISE  ] ] = quantity( "normal stress (ZZ)", mass_exponent=+1.0, length_exponent=-1.0, time_exponent=-2.0, )
...
quantities[ sd.Q_VELOCITY_COVARIANCE[sd.D_STREAMWISE,sd.D_STREAMWISE] ] = quantity( "velocity covariance (XX)", length_exponent=+2.0, time_exponent=-2.0, )
quantities[ sd.Q_VELOCITY_COVARIANCE[sd.D_STREAMWISE,sd.D_TRANSVERSE] ] = quantity( "velocity covariance (XY)", length_exponent=+2.0, time_exponent=-2.0, )
quantities[ sd.Q_VELOCITY_COVARIANCE[sd.D_STREAMWISE,sd.D_SPANWISE  ] ] = quantity( "velocity covariance (XZ)", length_exponent=+2.0, time_exponent=-2.0, )
quantities[ sd.Q_VELOCITY_COVARIANCE[sd.D_TRANSVERSE,sd.D_TRANSVERSE] ] = quantity( "velocity covariance (YY)", length_exponent=+2.0, time_exponent=-2.0, )
quantities[ sd.Q_VELOCITY_COVARIANCE[sd.D_TRANSVERSE,sd.D_SPANWISE  ] ] = quantity( "velocity covariance (YZ)", length_exponent=+2.0, time_exponent=-2.0, )
quantities[ sd.Q_VELOCITY_COVARIANCE[sd.D_SPANWISE,  sd.D_SPANWISE  ] ] = quantity( "velocity covariance (ZZ)", length_exponent=+2.0, time_exponent=-2.0, )

quantities[ sd.Q_INNER_LAYER_VELOCITY_COVARIANCE[sd.D_STREAMWISE,sd.D_STREAMWISE] ] = quantity( "inner-layer velocity covariance (XX)", )
quantities[ sd.Q_INNER_LAYER_VELOCITY_COVARIANCE[sd.D_STREAMWISE,sd.D_TRANSVERSE] ] = quantity( "inner-layer velocity covariance (XY)", )
quantities[ sd.Q_INNER_LAYER_VELOCITY_COVARIANCE[sd.D_STREAMWISE,sd.D_SPANWISE  ] ] = quantity( "inner-layer velocity covariance (XZ)", )
quantities[ sd.Q_INNER_LAYER_VELOCITY_COVARIANCE[sd.D_TRANSVERSE,sd.D_TRANSVERSE] ] = quantity( "inner-layer velocity covariance (YY)", )
quantities[ sd.Q_INNER_LAYER_VELOCITY_COVARIANCE[sd.D_TRANSVERSE,sd.D_SPANWISE  ] ] = quantity( "inner-layer velocity covariance (YZ)", )
quantities[ sd.Q_INNER_LAYER_VELOCITY_COVARIANCE[sd.D_SPANWISE,  sd.D_SPANWISE  ] ] = quantity( "inner-layer velocity covariance (ZZ)", )

quantities[ sd.Q_MORKOVIN_SCALED_VELOCITY_COVARIANCE[sd.D_STREAMWISE,sd.D_STREAMWISE] ] = quantity( "Morkovin-scaled velocity covariance (XX)", )
quantities[ sd.Q_MORKOVIN_SCALED_VELOCITY_COVARIANCE[sd.D_STREAMWISE,sd.D_TRANSVERSE] ] = quantity( "Morkovin-scaled velocity covariance (XY)", )
quantities[ sd.Q_MORKOVIN_SCALED_VELOCITY_COVARIANCE[sd.D_STREAMWISE,sd.D_SPANWISE  ] ] = quantity( "Morkovin-scaled velocity covariance (XZ)", )
quantities[ sd.Q_MORKOVIN_SCALED_VELOCITY_COVARIANCE[sd.D_TRANSVERSE,sd.D_TRANSVERSE] ] = quantity( "Morkovin-scaled velocity covariance (YY)", )
quantities[ sd.Q_MORKOVIN_SCALED_VELOCITY_COVARIANCE[sd.D_TRANSVERSE,sd.D_SPANWISE  ] ] = quantity( "Morkovin-scaled velocity covariance (YZ)", )
quantities[ sd.Q_MORKOVIN_SCALED_VELOCITY_COVARIANCE[sd.D_SPANWISE,  sd.D_SPANWISE  ] ] = quantity( "Morkovin-scaled velocity covariance (ZZ)", )
